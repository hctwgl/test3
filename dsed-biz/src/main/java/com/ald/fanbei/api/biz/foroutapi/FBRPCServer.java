package com.ald.fanbei.api.biz.foroutapi;
...
/**
 * @author honghzengpei 2017/9/18 15:40
 * @类描述：订单支付
 * @注意：本内容仅限于杭州阿拉丁信息科技股份有限公司内部传阅，禁止外泄以及用于其他的商业目的
 */
public class FBRPCServer {
    ...
    public void registService(Object service){
        ...
        for(Class<?> zz : interfaces){
            AFBRPCService rpcS = zz.getAnnotation(AFBRPCService.class);
            if(rpcS !=null){
                serviceTargets.put(rpcS.name(), service) ;
            }
        }
