 ...
 * @author xiaotianjian
 * @version 1.0.0 初始化
 * @date 2017-07-08 14:16:01 Copyright 本内容仅限于杭州阿拉丁信息科技股份有限公司内部传阅，禁止外泄以及用于其他的商业目的
 */
...
public class AfUserVirtualAccountServiceImpl extends ParentServiceImpl<AfUserVirtualAccountDo, Long> implements AfUserVirtualAccountService {
    ...
    @Override
    public BigDecimal getCurrentDayUsedAmount(String virtualCode) {

	return afUserVirtualAccountDao.getCurrentDayUsedAmount(virtualCode);
    }
}