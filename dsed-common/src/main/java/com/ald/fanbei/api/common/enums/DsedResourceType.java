 ...
 *
 */
public enum DsedResourceType {
	INVITE_TASK("INVITE_TASK","边逛边赚任务"),
    ...
    BindBankCardActivityCouponInfo("Bind_BankCard_Activity_CouponInfo","绑卡推广活动优惠券信息"),
	BindBankCardActivityRuleInfo("Bind_BankCard_Activity_RuleInfo","绑卡推广活动规则信息"),
	//借钱模块
	...
	BindBankCardCouponGift("Bind_BankCard_COUPON_GIFT", "绑信用卡礼包优惠券"),
	...
	TEMPRARY_SWITCH("TEMPRARY_SWITCH","临时额度开关"),
	...
	FRIRST_SIGLE_REGISTER("FRIRST_SIGLE_REGISTER", "新人专享推广注册"),
	COUNT_DOWN_BANNER("COUNT_DOWN_BANNER","品牌日大图"),
	// 天天拆红包配置
	OPEN_REDPACKET("OPEN_REDPACKET", "天天拆红包"),


	//一元购优惠券领取短信
	ONEYUANBUY_GET_SMS_TEMPLATE("ONEYUANBUY_GET_SMS_TEMPLATE","一元购优惠券领取短信文案"),
	ONEYUANBUY_GET_OUT_SMS_TEMPLATE("ONEYUANBUY_GET_OUT_SMS_TEMPLATE","一元购优惠券已领完短信文案");


	private String code;
    private String name;
    DsedResourceType(String code, String name) {
        this.code = code;
        this.name = name;
    }
