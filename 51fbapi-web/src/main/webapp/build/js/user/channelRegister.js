...
$(function(){
    ...
    $("#register_submitBtn").click(function(){ // 完成注册提交
        ...
        if(style!='8'&&style!='9'&&style!='10'&&style!='11'&&style!='12'&&style!='13'){ //样式8,9无密码
            // md5加密
        ...
        if(/^1(3|4|5|6|7|8|9)\d{9}$/i.test(mobileNum) && mobileNum != "" ){ // 判断电话开头
            if ( register_verification != "" ) { // 验证码不能为空
                if ( style=='8'||style=='9'||style=='10'||style=='11'||style=='12'||style=='13'||(password && 6 <= passwordLength && passwordLength <= 18 )) { // 密码6-18位
                    if ($("#input_check").is(":checked") || (style=='12'||style=='13')) { // 判断当前是否选中
