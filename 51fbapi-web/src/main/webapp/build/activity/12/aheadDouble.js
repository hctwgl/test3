    ...
    methods: {
        ...
        logData: function () { // get 初始化 信息
            ...
            $.ajax({
                ...
                success: function (data) {
                    self.couponData = eval('(' + data + ')').data.couponInfoList;
            ...
            $.ajax({
                ...
                success: function (returnData) {
                    ...
                    if (returnData.success) {
                        requestMsg("优惠劵领取成功");
                        self.$set(self.couponData[index], 'drawStatus', 'Y');
        ...
        maidian(data) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {
                    maidianInfo:'/fanbei-web/activity/aheadDouble?' + data
                },
                success: function (data) {
                    console.log(data)
                }
