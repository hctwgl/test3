...
$(function () {
    ...
    $(".checkbtn").click(function(){
        ...
        $.ajax({
            ...
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggNewAdqt?activityId=1&type=new_img'},
    ...
    $("#imgVftCodeSbumit").click(function(){
        ...
        $.ajax({
            url:'/fanbei-web/postMaidianInfo',
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggNewAdqt?activityId=1&type=new_sure'},
            success:function (data) {
                console.log(data)
            }
        });
    ...
    $(".loginbtn").click(function () {
        ...
        $.ajax({
            url:'/fanbei-web/postMaidianInfo',
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggNewAdqt?activityId=1&type=new_get'},
            success:function (data) {
                console.log(data)
            }
        });
