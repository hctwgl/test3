...
let vm=new Vue({
    ...
    data:{
        ...
        allData :[{'name':'苹果','img': imgrooturl +'/brand-01.png','src':'http://testapp.51fanbei.com/app/goods/goodsListModel?modelId=187'},
                  ...
                  {'name':'韩都衣舍','img':imgrooturl +'/brand-09.png','src':'http://testapp.51fanbei.com/app/goods/goodsListModel?modelId=185'},
                  {'name':'DW','img':imgrooturl +'/brand-16.png','src':'http://testapp.51fanbei.com/app/goods/goodsListModel?modelId=183'},
                  {'name':'nike','img':imgrooturl +'/brand-11.png','src':''},
                  {'name':'addidas','img':imgrooturl +'/brand-12.png','src':''},
                  {'name':'gxg','img':imgrooturl +'/brand-25.png','src':''},
                  {'name':'兰蔻','img':imgrooturl +'/brand-24.png','src':''},
                  {'name':'华为','img':imgrooturl +'/brand-03.png','src':''},
                  {'name':'小米','img':imgrooturl +'/brand-04.png','src':''},
                  {'name':'天梭','img':imgrooturl +'/brand-29.png','src':''},
                  {'name':'lilbetter','img':imgrooturl +'/brand-19.png','src':''},
                  {'name':'乐町','img':imgrooturl +'/brand-10.png','src':''},
                  {'name':'欧莱雅','img':imgrooturl +'/brand-29.png','src':''},
                  {'name':'马克华菲','img':imgrooturl +'/brand-05.png','src':''},
                  {'name':'李宁','img':imgrooturl +'/brand-27.png','src':''},
                  {'name':'CK','img':imgrooturl +'/brand-26.png','src':''},
                  {'name':'newbalance','img':imgrooturl +'/brand-13.png','src':''},
                  {'name':'拉夏贝尔','img':imgrooturl +'/brand-08.png','src':''},
                  {'name':'Dickies','img':imgrooturl +'/brand-28.png','src':''},
