    ...
    data: {
        ...
        allData: [{
            ...
            },
            {
                ...
                'src': 'https://app.51fanbei.com/app/goods/goodsListModel?modelId=153'
            },
            {
                'name': 'DW',
        ...
        coupon() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    let clickStamp=clickTime.valueOf();//当前时间戳
                    console.log(clickStamp,'clickStamp');
                    let clickHour = new Date(clickStamp).getHours();//当前几时
                    console.log(clickHour,'clickHour')
                    if(clickHour<10){
                        //  $('.coupon').unbind("click"); //禁止优惠券点击事件
                        self.flag=false;
                    }
 */
                }
