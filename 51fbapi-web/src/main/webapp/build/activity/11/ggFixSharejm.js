...
$(function () {
    ...
    $(".checkbtn").click(function(){
        ...
        $.ajax({
            ...
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggFixSharejm?type=new_img&typeFrom='+typeFrom+'&typeFromNum='+typeFromNum},
    ...
    $("#imgVftCodeSbumit").click(function(){
        ...
        $.ajax({
            url:'/fanbei-web/postMaidianInfo',
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggFixSharejm?type=new_sure&typeFrom='+typeFrom+'&typeFromNum='+typeFromNum},
            success:function (data) {
                console.log(data)
            }
        });
    ...
    $(".loginbtn").click(function () {
                ...
                success: function (returnData) {
                    ...
                    if (a.success) {
                        ...
                        $.ajax({
                            url:'/fanbei-web/postMaidianInfo',
                            type:'post',
                            data:{maidianInfo:'/fanbei-web/activity/ggFixSharejm?type=new_success&typeFrom='+typeFrom+'&typeFromNum='+typeFromNum,'maidianInfo1':registerMobile},
                            success:function (data) {
                                console.log(data)
                            }
                        });
        ...
        $.ajax({
            url:'/fanbei-web/postMaidianInfo',
            type:'post',
            data:{maidianInfo:'/fanbei-web/activity/ggFixSharejm?type=new_get&typeFrom='+typeFrom+'&typeFromNum='+typeFromNum},
            success:function (data) {
                console.log(data)
            }
        });
    ...
    methods: {
        ...
        logData() {
            ...
            $.ajax({
                url:'/fanbei-web/postMaidianInfo',
                type:'post',
                data:{maidianInfo:'/fanbei-web/activity/ggFixSharejm?type=new_ini&typeFrom='+typeFrom+'&typeFromNum='+typeFromNum},
                success:function (data) {
                    console.log(data)
                }
            });
