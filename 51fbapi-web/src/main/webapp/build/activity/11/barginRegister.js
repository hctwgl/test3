    ...
    $(".loginbtn").click(function() {
        ...
        if (((userck) && yztrue && yzcheck != '') && (mmtrue && password != undefined)) {
                ...
                success: function(returnData) {
                    ...
                    if (a.success) {
                        ...
                        $.ajax({
                            ...
                            type: 'post',
                            data: { maidianInfo: '/fanbei-web/activity/barginRegister?type=registerSuccess&userName='+userName },
            ...
            $.ajax({
                url:'/fanbei-web/postMaidianInfo',
                type:'post',
                data:{maidianInfo:'/fanbei-web/activity/barginLogin?type=loginBtn&userName='+userNamePhone},
                success:function (data) {
                    console.log(data)
                }
            });
