            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.msg&&data.msg=='没有登录'){  //是否登录
                        ...
                        let dat='{"shareAppTitle":"20元话费、300M流量，3元超值购点击即领","shareAppContent":"爱上街超值新人礼：20元话费3元领，快来抢购吧~","shareAppImage":"https://f.51fanbei.com/h5/app/activity/11/newSpecial-02.png","shareAppUrl":"' + domainName + '/fanbei-web/activity/newSpecialShare'+ '","isSubmit":"Y","sharePage":"newSpecialShare'+'"}';
