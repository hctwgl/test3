...
function setShareType() {
    if (goodsType.indexOf('share')!== -1) {
        var arr = goodsType.split('share');
        goodsType = arr[1];
    }
    return goodsType;
}
...
let vm = new Vue({
    ...
    methods: {
        ...
        toList: function() {
            location.href = "./barginList?goodsId=" + goodsId + "&spread=" + spread;
        },
        toLogin: function() {
                    ...
                    success: function(data) {
                        ...
                        if (self.isWX) {
                            ...
                            var dat = {
                                ...
                                shareAppUrl: urlHost + '/fanbei-web/activity/barginProduct?goodsId=' + goodsId + '&productType=share' + productType + '&userName=' + getInfo().userName + "&spread=" + spread,
                                isSubmit: 'Y',
        ...
        maidian(data){
            ...
            $.ajax({
                ...
                type:'post',
                data:{maidianInfo:'/fanbei-web/activity/barginProduct?userName='+userName+'&goodsId='+goodsId+'&type='+productType , spread: spread },
                success:function (data) {
                    console.log(data)
                }
            });       
