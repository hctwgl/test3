...
function alaShareData(){
    var dataObj = { // 分享内容
        ...
        "shareAppUrl": domainName+"/fanbei-web/activity/ggpresents?loginSource=Z&userItemsId="+cardRid,  // 分享后的链接
