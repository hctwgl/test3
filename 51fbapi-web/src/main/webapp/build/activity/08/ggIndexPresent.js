...
$(function(){
    ...
    $('.surePresent').click(function(){
        ...
        if(numClick02<2){
            ...
            cardRid=arr[0];
            let dat='{"shareAppTitle":"全民集卡片 领取51元大奖","shareAppContent":"你的好友赠送了一张'+name+'卡给你，助你赢得51元大奖，速来领走吧~","shareAppImage":"http://f.51fanbei.com/h5/app/activity/08/gg31.png","shareAppUrl":"'+ domainName + '/fanbei-web/activity/ggpresents?showCode=showCode&loginSource=Z&userName='+userName+'&activityId='+activityId+'&userItemsId='+cardRid+'&sharePage=ggpresents_userItemsId_'+cardRid+'","isSubmit":"Y","sharePage":"ggpresents_userItemsId_'+cardRid+'_showCode"}';
