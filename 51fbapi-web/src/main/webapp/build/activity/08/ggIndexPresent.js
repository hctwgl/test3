...
$(function(){
    ...
    $('.surePresent').click(function(){
        ...
        if(numClick02<2){
            ...
            let shareCodeUrlAppUrl=domainName+'/fanbei-web/activity/ggpresents?loginSource=Z_userName='+userName+'_activityId='+activityId+'_userItemsId='+cardRid;
            let shareCodeUrlAppUrlBase64=BASE64.encoder(shareCodeUrlAppUrl); // shareCodeUrl中的shareAppUrl加密

            let dat='{"shareAppTitle":"全民集卡片 领取51元大奖","shareAppContent":"你的好友赠送了一张'+name+'卡给你，助你赢得51元大奖，速来领走吧~","shareAppImage":"http://f.51fanbei.com/h5/app/activity/08/gg31.png","shareAppUrl":"'+ domainName + '/fanbei-web/activity/ggpresents?loginSource=Z&userName='+userName+'&activityId='+activityId+'&userItemsId='+cardRid+'&sharePage=ggpresents_userItemsId_'+cardRid+'","shareCodeUrl":"'+domainName+'/H5GGShare/submitShareCode?userItemsId='+cardRid+'&shareAppUrl="'+shareCodeUrlAppUrl+'","isSubmit":"Y","sharePage":"ggpresents_userItemsId_'+cardRid+'"}';
