...
function alaShareData(){
    var dataObj = { // 分享内容
        ...
        "shareAppUrl": domainName+"/fanbei-web/activity/ggpresents?loginSource=Z&activityId="+activityId+"&userName="+userName+"&userItemsId="+cardRid,  // 分享后的链接
