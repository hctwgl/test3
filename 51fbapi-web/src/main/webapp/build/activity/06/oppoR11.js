    ...
    $.ajax({
        ...
        success: function(returnData){
            if (returnData.data.isHaveReservationRecord == "Y") {
                $("#btn").attr('src', 'https://f.51fanbei.com/h5/app/activity/06/oppo2_2.png');
            }
        },
        error: function(){
            requestMsg("请求失败");
...
new Vue({
    ...
    data: {
        ...
        bannerlist: 'https://f.51fanbei.com/h5/app/activity/06/oppo12_31.png',
    ...
    methods:{
        ...
        oppoR11List(e){
            ...
            // 手机的bannerlist
            this.bannerlist="https://f.51fanbei.com/h5/app/activity/06/oppo12_3"+e+".png";
