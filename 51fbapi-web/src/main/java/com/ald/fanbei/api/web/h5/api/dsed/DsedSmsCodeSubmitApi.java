...
public class DsedSmsCodeSubmitApi implements DsedH5Handle {
	...
	public DsedH5HandleResponse process(Context context)  {
		DsedH5HandleResponse resp = new DsedH5HandleResponse(200, "绑卡成功");
        ...
        if("BIND".equals(type)){
			...
			switch (beanName.toString()) {
				case "dsedLoanRepaymentService":
					map = dsedLoanRepaymentService.doUpsPay(String.valueOf(busiFlag), smsCode);
					break;
				default:
