package com.ald.fanbei.api.web.api.thrid;


import com.ald.fanbei.api.biz.auth.executor.AlipayAuthCallbackExecutor;
import com.ald.fanbei.api.biz.auth.executor.Executor;
 ...
 */
@Component("userReplenishQuotaApi")
public class UserReplenishQuotaApi implements Executor {
    ...
    private Logger logger = LoggerFactory.getLogger(UserReplenishQuotaApi.class);
