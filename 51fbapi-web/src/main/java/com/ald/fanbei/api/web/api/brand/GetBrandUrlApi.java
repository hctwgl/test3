...
//		String shopUrl = shopInfo.getShopUrl() + "/" +  + "?";
		...
		if(shopId == 2L){
			...
			shopUrl = "https://91ala.otosaas.com/menpiao?";
		} else if (shopId == 5L) {
			shopUrl = "https://91ala.otosaas.com/piaowu?";
		} else if (shopId == 6L) {
			shopUrl = "https://91ala.otosaas.com/jiayouka?";
		} else if (shopId == 7L) {
			shopUrl = "https://91ala.otosaas.com/chongzhi?";
		}
