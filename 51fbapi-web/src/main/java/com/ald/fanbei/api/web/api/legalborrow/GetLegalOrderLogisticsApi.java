...
@Component("getLegalOrderLogisticsApi")
public class GetLegalOrderLogisticsApi implements ApiHandle {
    @Autowired
    ...
    public ApiHandleResponse process(RequestDataVo requestDataVo, FanbeiContext context, HttpServletRequest request) {
        ...
        try {
            ...
            AfOrderLogisticsBo afOrderLogisticsBo= afOrderLogisticsService.getLegalOrderLogisticsBo(orderId,isOutTraces);
