...
public class DsedH5HandleResponse implements BaseResponse{
	...
	public DsedH5HandleResponse(String code, String msg, Object data) {
	...
	public static DsedH5HandleResponse getNewInstance(String code, String msg) {
	...
	public static DsedH5HandleResponse getNewInstance(String code, String msg, Object data) {
		DsedH5HandleResponse instance = new DsedH5HandleResponse();
		instance.setCode(code);
		instance.setMsg(msg);
