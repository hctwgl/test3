...
public class TradeWeiXinController extends BaseController {
    ...
    @RequestMapping(value = {"/login","/logout","/businessInfo","/twoBarCode","/getPayListDate", "/getPayList", "/getWithdrawListDate", "/getWithdrawList", "/getRefundListDate", "/getRefundList", "/withdraw", "/refund"},
