...
public class AfLimitDetailInfoVo extends AbstractSerial {
    ...
    private BigDecimal freePerAmount;//每期还款金额(免息)
    ...
    public BigDecimal getFreePerAmount() {
        return freePerAmount;
    }

    public void setFreePerAmount(BigDecimal freePerAmount) {
        this.freePerAmount = freePerAmount;
    }
}
