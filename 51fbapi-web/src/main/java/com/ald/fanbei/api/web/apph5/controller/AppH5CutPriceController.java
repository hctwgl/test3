...
public class AppH5CutPriceController extends BaseController {
	...
	/**
	 * 
	 * @Title: goodsInfo @Description: 获取商品砍价详情 @param request @param
	 *         response @return String @throws
	 */
	...
	/**
	 * 
	 * @Title: friend @Description: 获取商品砍价详情用户列表 @param request @param
	 *         response @return String @throws
	 */
	...
	public String friend(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			logger.info("/activity/de/friend : userName ={} , goodsPriceId = {}, goodsPriceId = {}", userName,
					goodsPriceId);
			Long userId = convertUserNameToUserId(userName);
	...
	/**
	 * 
	 * @Title: top @Description:获取砍价商品榜单信息 @param request @param
	 *         response @return String @throws
	 */
	 ...
	 * 
	 * 
	 * @Title: topList @Description: 获取砍价商品榜单列表 @param request @param
	 *         response @return String @throws
	 */
