...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value ={
    	"/order/confirmReceipt","/order/buySelfGoods","/order/mobileCharge","/order/getOrderDetailInfo","/order/getOrderList","/order/getOrderNoWithUser","/order/refundOrderApply","/order/deleteOrderInfo","/order/insufficientBalance"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
	...
	@RequestMapping(value = { "/auth/authRealname", "/auth/authContacts", "/auth/authCredit", "/auth/authZhima", "/auth/authBankcard", "/auth/checkBankcard", "/auth/getBankList",
			...
			"/auth/authSupplyCertify","/auth/authFund","/auth/authSocialSecurity","/auth/authCreditCard"}, method = RequestMethod.POST, produces = "application/json;charset=utf-8")
	@ResponseBody
