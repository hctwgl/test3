...
public class FanbeiController extends BaseController {
     ...
     * @throws IOException
     */
    @RequestMapping(value = {"/operataApp/getAgencyBuyOrderList","/operataApp/getAgencyBuyOrderInfo"},method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
