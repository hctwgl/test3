...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value = {"/borrowCash/getBorrowCashHomeInfo","/borrowCash/getBowCashLogInInfo","/borrowCash/getConfirmBorrowInfo","/borrowCash/applyBorrowCash",
    		...
    		"/borrowCash/getRenewalDetail","/borrowCash/getLoanSupermarketList","/loanMarket/accessLoanSupermarket","borrowCash/applyBorrowCashV1","/borrowCash/tearPacket"},method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
