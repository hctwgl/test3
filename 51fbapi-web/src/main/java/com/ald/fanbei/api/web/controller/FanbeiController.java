...
public class FanbeiController extends BaseController {
	...
	"/goods/addFootMark","/goods/getHomeInfo","/goods/getHomeInfoV1","/goods/getHomeInfoV2","/goods/getHomeInfoV3","/goods/getChannel","/goods/getMoreGoods","/goods/getChannelMoreGoods",
	...
	"/category/getAllGoodsCategory","/category/getGoodsList","/category/getGoodsList1", "/goods/getGoodsRateInfo","/goods/getThirdGoodsAuction","/goods/getThirdGoodsDetailInfo","/category/brandChannels"
    ...
    @RequestMapping(value ={
    	...
    	"/coupon/couponList","/mine/getInviteInfo","/mine/getOrderListCount","/mine/getSettingInfo","/order/payResultOfAlipay","/order/getOrderLogistics","/coupon/getDetailCouponList","/coupon/getPickCoupon"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
    ...
    @RequestMapping(value = {
            ...
            ,"/borrow/getDataView","/borrow/submitClear","/repayment/getPayTypeStatus"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
  ...
  * @throws IOException
  */
 @RequestMapping(value = {"/pay/quickPaymentResendCode","/pay/confirmPayment"},method = RequestMethod.POST,produces="application/json;charset=utf-8")
 @ResponseBody
 public String payRequest(@RequestBody String body, HttpServletRequest request, HttpServletResponse response) throws IOException{
     request.setCharacterEncoding(Constants.DEFAULT_ENCODE);
     response.setContentType("application/json;charset=utf-8");
     return this.processRequest(body, request, false);
 }
