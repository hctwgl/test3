...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value ={
    	"/system/appUpgrade","/system/commitFeedBack","/system/getSettingInfo","/system/checkVersion","/system/AppLaunchImage"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
    ...
    @RequestMapping(value = {"/borrowCash/getBorrowCashHomeInfo","/borrowCash/getBowCashLogInInfo","/borrowCash/getConfirmBorrowInfo","/borrowCash/applyBorrowCash",
    		...
    		"/repayCash/getRepayCashList","/repayCash/getRepayCashInfo","/borrowCash/applyRenewal","/borrowCash/renewalRecord","/borrowCash/getRenewalDetail"},method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
