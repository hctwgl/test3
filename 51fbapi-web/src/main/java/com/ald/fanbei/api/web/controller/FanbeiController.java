...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value = {
    		...
    		"/user/commitFeedback","/user/getCouponList","/user/pickCoupon","/user/getEmailVerifyCode","/user/checkPayPwd","/user/getSigninInfo","/user/setPayPwd","/user/getPayPwdVerifyCode","/user/checkPayPwdVerifyCode","/user/checkIdNumber","/user/changeLoginPwd","/user/getInvitationInfo","/user/signin","/user/changeMobile"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
