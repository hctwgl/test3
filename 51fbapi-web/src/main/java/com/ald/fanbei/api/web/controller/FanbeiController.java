...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value ={
    	...
    	"/coupon/couponList","/mine/getInviteInfo","/mine/getOrderListCount","/mine/getSettingInfo","/order/payResultOfAlipay","/order/getOrderLogistics","/coupon/getDetailCouponList"
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
