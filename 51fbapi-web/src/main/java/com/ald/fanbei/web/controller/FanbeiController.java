package com.ald.fanbei.web.controller;
...
import com.ald.fanbei.web.common.ApiHandleResponse;
import com.ald.fanbei.web.common.BaseController;
import com.ald.fanbei.web.common.RequestDataVo;
...
public class FanbeiController extends BaseController {
    ...
    @RequestMapping(value ={
    	"/system/appUpgrade","/system/commitFeedBack","/system/feedbackList","/system/getArea",
    },method = RequestMethod.POST,produces="application/json;charset=utf-8")
    @ResponseBody
