...
//        	    getBoluomeString("ala202987199959391","5899181","1");
//        	    getBoluomeString("ala202987209019993","5897894","1.5");
//        	    getBoluomeString("ala202987213886285","5861906","6.5");
//        	    getBoluomeString("ala202987222520546","5896350","15.5");
//        	    getBoluomeString("ala202987253732560","5901199","9.5");
	...
	private static void getBoluomeString(String thirdOrderOn,String userId,String amount)
	{
	    Map<String, String> params = new HashMap<String, String>();
	        params.put(ThirdCore.ORDER_ID, thirdOrderOn);
	        params.put(ThirdCore.USER_ID, userId);
	        params.put(ThirdCore.TIME_STAMP, String.valueOf(System.currentTimeMillis()));
	        params.put(ThirdCore.PLANT_FORM, "BOLUOME");
	        params.put(ThirdCore.APP_KEY, "2268c37e-a0fc-413f-935f-6e4d5b442b07");
	        params.put(ThirdCore.AMOUNT, amount);
	        params.put(ThirdCore.REFUND_NO, "ala223043550434860");
	        params.put(ThirdCore.REFUND_SOURCE, "P");
	        
	        String beforeSign = "2268c37e-a0fc-413f-935f-6e4d5b442b07" + BoluomeCore.concatParams(params) + "D2I0sRJeTNcNZAC94qH52j0lwZa5JVly06xy5Mv1uQ0w6Fj92bZQEZJmcCT4yD4S";
	    	String sign = DigestUtil.MD5(beforeSign);
