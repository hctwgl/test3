...
public class AfAuthRaiseStatusServiceImpl extends ParentServiceImpl<AfAuthRaiseStatusDo, Long>
		implements AfAuthRaiseStatusService {
	...
	public void saveOrUpdateRaiseStatus(AfAuthRaiseStatusDo raiseStatus) {
		...
		AfAuthRaiseStatusDo existRaiseStatusDo = afAuthRaiseStatusDao.getByPrdTypeAndAuthType(raiseStatus.getPrdType(),raiseStatus.getAuthType());
