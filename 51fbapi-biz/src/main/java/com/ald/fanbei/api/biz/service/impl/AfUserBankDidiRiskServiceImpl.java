 ...
 * @author xiaotianjian
 * @version 1.0.0 初始化
 * @date 2017-08-14 13:41:55 Copyright 本内容仅限于杭州阿拉丁信息科技股份有限公司内部传阅，禁止外泄以及用于其他的商业目的
 */
...
public class AfUserBankDidiRiskServiceImpl extends ParentServiceImpl<AfUserBankDidiRiskDo, Long> implements AfUserBankDidiRiskService {
	...
	@Override
	public int saveRecordList(List<AfUserBankDidiRiskDo> list) {
		return afUserBankDidiRiskDao.saveRecordList(list);
	}
}