...
public class SmsUtil extends AbstractThird {
	...
	private static String GOODS_RESERVATION_SUCCESS = "恭喜您！预约成功！OPPO R11将于6月22日10点准时开售，0元预约购机享12期免息再送价值300元原装配件，不要错过哦！";
    ...
    public  boolean sendGoodsReservationSuccessMsg(String mobile) {
        SmsResult smsResult = sendSmsToDhst(mobile, GOODS_RESERVATION_SUCCESS);
        return smsResult.isSucc();
    }
