...
public interface AfRepaymentBorrowCashService {
	Map<String, String> createRepaymentYiBao(BigDecimal jfbAmount, BigDecimal repaymentAmount, BigDecimal actualAmount, AfUserCouponDto coupon, BigDecimal rebateAmount,
