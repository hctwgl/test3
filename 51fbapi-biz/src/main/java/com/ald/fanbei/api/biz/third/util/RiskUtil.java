...
//		obj.put("imei", imei);
    ...
    public static void main(String[] args) {
        ...
        riskCreditBo.setConsumeBorrowAmount(new BigDecimal(1000));
        riskCreditBo.setConsumeOverdueDay(1);
        riskCreditBo.setConsumePayOffCount(10);
        riskCreditBo.setLoanOverdueDay(1);
        riskCreditBo.setLoanPayOffCount(5);
        String orderNo = "6214835897002448";
        String riskOrderNo = getOrderNo("vefy", orderNo.substring(orderNo.length() - 4, orderNo.length()));
        //	bizCacheUtil
        creditPayment("15990182307", riskOrderNo);
    }
}
