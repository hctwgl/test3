...
public AfResourceH5Dto(Long id, Date gmtCreate, Date gmtModified,
		String creator, String modifier, String name, String url, Long status,
		Long sort) {
	super(id, gmtCreate, gmtModified, creator, modifier, name, url, status, sort);
	// TODO Auto-generated constructor stub
}
