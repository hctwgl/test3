 ...
 */
 public class AfAssetSideOperaLogDo extends AbstractSerial {
    ...
    /**
     * 操作类型(getasset:获取债权资产  giveback:退回债权资产 )
     */
    ...
    public AfAssetSideOperaLogDo() {
		super();
	}
    
	public AfAssetSideOperaLogDo(Long assetSideId, Date gmtCreate,
    ...
    /**
     * 获取操作类型(getasset:获取债权资产  giveback:退回债权资产 )
     *
     * @return 操作类型(getasset:获取债权资产  giveback:退回债权资产 )
     */
    ...
    /**
     * 设置操作类型(getasset:获取债权资产  giveback:退回债权资产 )
     * 
     * @param changeType 要设置的操作类型(getasset:获取债权资产  giveback:退回债权资产 )
     */
