 ...
 */
 public class AfBoluomeActivityItemsDo extends AbstractSerial {
     ...
     * 
     * @param boluomeActivityId 要设置的活动id【boluome_activity_id】
     */
     ...
     * 
     * @param refId 要设置的关联表ID type为CARD 则为商城id
     */
