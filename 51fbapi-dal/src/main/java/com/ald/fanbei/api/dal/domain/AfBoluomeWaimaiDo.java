 ...
 */
 public class AfBoluomeWaimaiDo extends AbstractSerial {
     ...
     * 设置商品详细信息（json）
     * 
     * @param goodsinfo 要设置的商品详细信息（json）
     */
     ...
     * 设置预计配送完成时间
     * 
     * @param deliveryTimeShow 要设置的预计配送完成时间
     */
     ...
     * 设置店铺联系电话
     * 
     * @param restaurantPhone 要设置的店铺联系电话
     */
     ...
     * 设置收件联系人手机号
     * 
     * @param contactMobile 要设置的收件联系人手机号
     */
