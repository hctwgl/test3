...
public class AntxPropTest {
	public static void main(String[] args) {
    	...
    	// dev
        String decryptStr = AesUtil.decryptFromBase64("SNDKc0tZOaoebiGNVCXMBBbDYcFJF/f2SPzQom7gePc=", "Cw5bM6x@6sH$2dlw^3JueH");
        System.out.println(decryptStr);
       
        String dbUrl = "jdbc:mysql://192.168.112.31:3306/jsd_loan";
