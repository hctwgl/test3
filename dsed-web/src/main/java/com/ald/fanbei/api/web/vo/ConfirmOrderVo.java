 ...
 */
public class ConfirmOrderVo extends AbstractSerial{
	...
	private AfCheckoutCounterDo cashierConfig;//二级分类
	/**
	 * @return the rid
	 */
	public Long getRid() {
	...
	public AfCheckoutCounterDo getCashierConfig() {
		return cashierConfig;
	}

	public void setCashierConfig(AfCheckoutCounterDo cashierConfig) {
