package com.ald.fanbei.api.web.api.geetest;
...
public class GeetestLib {
	 ...
	 */
	public static final String FN_GEETEST_CHALLENGE = "geetestChallenge";

	/**
	 * 极验验证二次验证表单数据 validate
	 */
	public static final String FN_GEETEST_VALIDATE = "geetestValidate";

	/**
	 * 极验验证二次验证表单数据 seccode
	 */
	public static final String FN_GEETEST_SECCODE = "geetestSeccode";
	 ...
	 */
	public String gtServerStatusSessionKey = "gtServerStatus";
