 ...
 */
 public class JsdBankDo extends AbstractSerial {
    ...
    /**
     * 获取代扣WITHHOLD、快捷支付KUAIJIE(有短信)
     *
     * @return 代扣WITHHOLD、快捷支付KUAIJIE(有短信)
     */
    ...
    /**
     * 设置代扣WITHHOLD、快捷支付KUAIJIE(有短信)
     * 
     * @param payType 要设置的代扣WITHHOLD、快捷支付KUAIJIE(有短信)
     */
