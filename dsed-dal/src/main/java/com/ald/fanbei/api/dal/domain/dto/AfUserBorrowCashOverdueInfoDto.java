 ...
 * @author chengkang
 */
public class AfUserBorrowCashOverdueInfoDto implements Serializable {
	...
	public AfUserBorrowCashOverdueInfoDto() {
		super();
	}
	public AfUserBorrowCashOverdueInfoDto(Integer overdueNums,
