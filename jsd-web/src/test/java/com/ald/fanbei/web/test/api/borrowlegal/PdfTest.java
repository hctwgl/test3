...
//	@Test
	public void renewal() {
		String url = urlBase + "/fanbei-web/lease/completedLeaseOrder";
		Map<String,String> params = new HashMap<>();
		params.put("orderId", "1259666");
		testApi(url, params, userName ,true);
	}

	@Test
	public void getCashPageType() {
		String url = urlBase + "/fanbei-web/lease/completedLeaseOrder?orderId=111&userName=15669066271";
		Map<String,String> params = new HashMap<>();
		params.put("orderId", "1259666");
