...
public enum ResourceSecType {
		...
		OVERDUE_CONFIG("OVERDUE_CONFIG", "逾期相关配置"),
		...
		RISK_DAILY_RATE_SWITCH("RISK_DAILY_RATE_SWITCH", "分层利率缓存开关"),
		...
		PROTOCOL_BORROW_DIGITAL_CERTIFICATE("PROTOCOL_BORROW_DIGITAL_CERTIFICATE","数字证书服务协议(暂不用)"),
		PROTOCOL_BORROW_ORDER("PROTOCOL_BORROW_ORDER","分期服务协议"),
		//代买协议
