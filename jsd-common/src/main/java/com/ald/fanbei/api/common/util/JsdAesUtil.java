...
//            kgen.init(128, new SecureRandom(password.getBytes()));
    ...
    public static void main(String[] args) {
        String encryptStr = new String(Base64.encodeBase64(encrypt("192.168.112.38", "testC1b6x@6aH$2dlw")));
        System.out.println(encryptStr);
        System.out.println(decryptFromBase64("IJgdKMamAcP5btliO3edNq7Dc1rJrWG6qZ7zI9RsgCA=", "testC1b6x@6aH$2dlw"));
